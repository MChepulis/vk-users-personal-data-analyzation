...
tasks_dict = {
    ...
    7: {
        "function": has_city,
        "description": "Доли пользователей, которые указали/не указали город проживания (Доли пользователей, которые заполнили графу \"город проживания\")",
        "has_size": False
    },
    8: {
    ...
    18: {
        ...
        "description": "Изображает на карте топ N (default: 10) городов из топ N стран по количество пользователей",
        "has_size": True,
        "default": 10
    },
    19: {
        "function": countries_on_map,
        "description": "Изображает на карте топ N (default: 10) стран по количество пользователей",
        "has_size": True,
        "default": 10
    }
}
